...
rectas(0.3375 + 0.1713, 0.344 + 0.17135,
       950, 1280,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.1) # no se completa
...
expo(0.3498 + 0.1713, 0.3760 + 0.1713,
       1280, 950,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, ruido_alfa) # no se completa
...
expo(0.3498 + 0.3005, 0.4102 + 0.3005,
       960, 400,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.05) # no se completa

expo(0.3498 + 0.3005, 0.3760 + 0.3005,
       1280, 950,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.05) # no se completa
...
rectas(0.9987 + 1.0539, 1.0675 + 1.0539,
       1800, 800,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.15) # no se completa
...
rectas(0.8129 + 2.2578, 0.8342 + 2.2578,
       940, 940,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.4) # no se completa
...
rectas(0.9987 + 2.2578, 1.0675 + 2.2578,
       1800, 800,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.15) # no se completa
...
# t3 
senito(2.6749 + 1.2029, 2.701 + 1.20299,
         680, 100,
         np.pi*3/2 , np.pi*(3.5),
         frequencias, silabas_timestamp,
         ruido_beta_list, ruido_beta, ruido_alfa)
...
rectas(0.9987 + 3.4604, 1.0675 + 3.4604,
       1800, 800,
       frequencias, silabas_timestamp,
       ruido_beta_list, ruido_beta, 0.15) # no se completa
